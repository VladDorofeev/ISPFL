...
os.makedirs("outputs/ISP_experiments/image_net/", exist_ok=True)
...
def build_command(federated_method):
    ...
    if args.dynamic_clients:
        ...
        params.append("federated_method.warmup=10")

    # Build output filename
    output_name = f"outputs/ISP_experiments/image_net/{federated_method}_imagenet.txt"
    if args.dynamic_clients:
